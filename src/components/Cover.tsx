      ...
      <div className="relative z-1">
        ...
        <div className="flex flex-col relative justify-center z-10 min-h-[400px] md:min-h-[700px] home-cover">
          ...
          <div className="flex justify-center mb-6">
            <Link
             className="text-white bg-[#dac172] text-[14px] text-center px-[25px] py-[15px] me-2 mb-2 border border-[#dac172] min-w-[175px] w-auto rounded-none transition-all duration-300 ease-in-out hover:bg-transparent hover:border-[#dac172] hover:text-[#dac172]"
