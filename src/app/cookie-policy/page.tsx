...
import { GET__COOKIE_POLICY } from "@/graphql/queries/getPrivacyPolicy";
...
export default function ContactPage() {
    ...
    return (
    <div className="grid">
      <div className="container mx-auto w-full sm:w-11/12 lg:w-[1170px] my-10 sm:my-20 cookie-policy px-2">
