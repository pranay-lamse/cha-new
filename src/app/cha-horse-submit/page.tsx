...
export default function HoursSubmitPage() {
  ...
  return (
    <>
      ...
      <div className="container mx-auto w-full sm:w-11/12 lg:w-[1170px] my-10 sm:my-20 about px-2 sm:px-0 cha-horse-submit-page">
        <div className="relative justify-center border-4 border-[#dcc373] bg-[url('/assets/img/cover-image.jpg')] bg-cover bg-center p-10 add-horse-page">
          {/* Overlay */}
          <div className="absolute inset-0 bg-black opacity-[0.8]"></div>
          <div className="border-b-2 border-[#dcc373] w-full relative mb-4">
            <div className=" w-full h-full flex justify-center items-center py-8 cha-horse-logo">
              <Image
            ...
            <div className="grid md:grid-cols-2 gap-4 w-full py-10 cha-form-page">
              <div className="grid px-5 py-8 cha-horse-page">
                <Image
              ...
              <div className="pl-8 pr-4 py-2 justify-center items-center text-center horse-resp">
                <h2
          ...
          <div className="relative p-14 bg-[#dcc373] shadow-lg rounded-lg mx-[20px] my-[80px] add-horse-one">
            <h2
              className={`${cormorantSC.className} text-[24px] md:text-[42px] font-semibold text-[#000] text-center pb-[15px] sm:pb-[25px]`}
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="flex flex-col w-full">
                  <label
                    className={`${lora.className} text-[#000] text-[14px] sm:text-[16px] pb-2 sm:pb-3`}
                  >
                    Name
                  </label>
                  <input
              ...
              <div className="flex flex-col">
                <label
                  className={`${lora.className} text-[#000] text-[16px] pb-3`}
                >
                  Street Address
                </label>
                <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col">
                  <label
                    className={`${lora.className} text-[#000] text-[16px] pb-1`}
                  >
                    Documents to upload (Registration Papers, Coggins, Vet
                    Inspection)
                  </label>
              ...
              <div className="flex flex-col">
                <label
                  className={`${lora.className} text-[#000] text-[16px] pb-3`}
                >
                  Auction Reserve Price (This is the MINIMUM price you will
                  accept before commission) (NOTE that horses generate more
                  interest once reserve price is met)
                </label>
                <input
                  type="text"
                  name="Auction"
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                <div className="flex flex-col w-full">
                  ...
                  >
                    Review{" "}
                    <a
                      href="https://classichorseauction.com/seller-terms-conditions/"
                      className="text-[#0F335F] hover:underline"
                    >
                      Seller Terms
                    </a>
                  </label>
                  <div className="flex items-center gap-2">
                    ...
                    <label
                      htmlFor="sellerTerms"
                      className={`${lora.className} text-[#000] text-[14px]`}
                    >
              ...
              <div className="flex flex-col w-full">
                <div className="flex flex-col w-full">
                  ...
                  >
                    Photo{" "}
                    <a
                      href="https://classichorseauction.com/seller-terms-conditions/#photo"
                      className="text-[#0F335F] hover:underline"
                    >
                      Consent Terms
                    </a>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <em>
                        If you did not personally take the photos you submit,
                        you must provide written permission from the copyright
                        holder to use them.
                      </em>
                    </label>
                  </div>
